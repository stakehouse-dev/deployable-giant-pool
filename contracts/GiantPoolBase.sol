...
abstract contract GiantPoolBase is ITransferHookProcessor, ReentrancyGuardUpgradeable, ETHTransferHelper, OwnableUpgradeable {
    ...
    function _assertContractNotPaused() internal view virtual {}
}